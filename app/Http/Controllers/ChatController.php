...
class ChatController extends Controller
{
    ...
    {
        $matcing_user_id = $request->user_id;
        ...
        if ($chat_room_id->isEmpty()) {
            ...
            // 新規登録 モデル側の$fillableで許可したフィールドを指定して保存
            ChatRoomUser::create(
                [
        ...
        // チャット相手のユーザー情報を取得
        $chat_room_user = User::findOrFail($matcing_user_id);
        ...
        return view('chat.show',
            compact('chat_room_id', 'chat_room_user', 'chat_messages', 'chat_room_user_name')
            );
    }
}
